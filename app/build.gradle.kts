...
dependencies {
    implementation(platform("dev.tamboui:tamboui-bom:0.4.0"))
...
// Keep the standard JAR simple; do not unpack dependencies here
tasks.jar {
    manifest {
...
// Consolidate Shadow JAR configuration to merge Lucene SPI files correctly
tasks.shadowJar {
